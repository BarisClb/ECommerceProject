			...
			<Modal isOpen={modal} toggle={toggle} centered>
				...
				<ModalBody className="modal-form">
					...
					<div className="modal-form-item modal-form-id">
						<label
							htmlFor="modal-seller-update-form-id"
					...
					<div className="modal-form-item modal-form-name">
						<label
							htmlFor="modal-seller-update-form-name"
							className="form-label"
						>
							Name
						</label>
					...
					<div className="modal-form-item modal-form-username">
						<label
							htmlFor="modal-seller-update-form-username"
							className="form-label"
						>
							Username
						</label>
					...
					<div className="modal-form-item modal-form-eMail">
						<label
							htmlFor="modal-seller-update-form-eMail"
							className="form-label"
						>
							EMail
						</label>
					...
					<div className="modal-form-item modal-form-password">
						<label
							htmlFor="modal-seller-update-form-password"
							className="form-label"
						>
							Password
						</label>
